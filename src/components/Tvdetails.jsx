     ...
     className='relative w-screen h-[180vh] px-[10%]'>
      ...
      <nav className='h-[10vh] w-full text-zinc-100 flex items-center gap-10 text-xl'>
            ...
            <a target='_blank' href={info.detail.homepage}>
              <i className="hover:text-[#EAB308] ri-external-link-fill"></i>
            </a>
            <a target='_blank' href={`https://www.wikidata.org/wiki/${info.externalid.wikidata_id}`}>
              <i className="hover:text-[#EAB308] ri-earth-fill "></i>
            </a>
            <a target='_blank'className='hover:text-[#EAB308] font-bold' href={`https://www.imdb.com/title/${info.externalid.imdb_id}/`}>
              IMDb
            </a>
           ...
           <div className='content ml-[5%] text-white'>
            <h1 className='text-5xl font-black'>
              {info.detail.name || 
               ...
               <h1 className='text-2xl mb-3 mt-5 underline decoration-zinc-300'>Overview</h1>
               <p>{info.detail.overview}</p>

               <h1 className='text-2xl mb-3 mt-5 underline decoration-zinc-300'>Tv Translations</h1>
               <p className='mb-10'>{info.translations.join(", ")}</p>

               <Link
                className='px-4 py-3 bg-[#6556CD] hover:border rounded-lg font-bold text-lg' 
                to={`${pathname}/trailer`}>
                  <i className="ri-play-large-fill mr-3 "></i>Play Trailer
                  </Link>
      ...
      <hr className='mt-10 mb-5 border-none h-[2px] bg-zinc-500'/>
           ...
           info.detail.seasons.length >0 ? (info.detail.seasons.map((s,i)=>(
              <div className='w-[15vh] mr-[10%]'>
                   <img 
           className='shadow-[8px_17px_38px_2px_rgba(0,0,0,.5)] min-w-[14vw] h-[30vh] object-top ' 
       ...
       {/* Part-5 Recommendations and similar stuffs */}
           <hr className='mt-10 mb-5 border-none h-[2px] bg-zinc-500'/>
           <h1 className='text-3xl font-bold text-white'>Recommendations & Similar Stuffs</h1>
